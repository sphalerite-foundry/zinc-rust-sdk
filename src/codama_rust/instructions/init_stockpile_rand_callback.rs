...
use crate::codama_rust::types::SignedComputationOutputsInitStockpileRandOutput;
use borsh::BorshDeserialize;
use borsh::BorshSerialize;

pub const INIT_STOCKPILE_RAND_CALLBACK_DISCRIMINATOR: [u8; 8] =
    [198, 198, 8, 119, 229, 69, 211, 83];

/// Accounts.
#[derive(Debug)]
pub struct InitStockpileRandCallback {
...
impl InitStockpileRandCallback {
    pub fn instruction(
        &self,
        args: InitStockpileRandCallbackInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = InitStockpileRandCallbackInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct InitStockpileRandCallbackInstructionData {
    discriminator: [u8; 8],
}

impl InitStockpileRandCallbackInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [198, 198, 8, 119, 229, 69, 211, 83],
        }
    }
...
impl Default for InitStockpileRandCallbackInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
pub struct InitStockpileRandCallbackInstructionArgs {
    pub output: SignedComputationOutputsInitStockpileRandOutput,
}

impl InitStockpileRandCallbackInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `InitStockpileRandCallback`.
///
/// ### Accounts:
///
...
///   8. `[writable]` stockpile_secret
#[derive(Clone, Debug, Default)]
pub struct InitStockpileRandCallbackBuilder {
    ...
    output: Option<SignedComputationOutputsInitStockpileRandOutput>,
    __remaining_accounts: Vec<solana_instruction::AccountMeta>,
}

impl InitStockpileRandCallbackBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    ...
    #[inline(always)]
    pub fn output(&mut self, output: SignedComputationOutputsInitStockpileRandOutput) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = InitStockpileRandCallback {
        ...
        let args = InitStockpileRandCallbackInstructionArgs {
...
/// `init_stockpile_rand_callback` CPI accounts.
pub struct InitStockpileRandCallbackCpiAccounts<'a, 'b> {
...
/// `init_stockpile_rand_callback` CPI instruction.
pub struct InitStockpileRandCallbackCpi<'a, 'b> {
    ...
    pub __args: InitStockpileRandCallbackInstructionArgs,
}

impl<'a, 'b> InitStockpileRandCallbackCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: InitStockpileRandCallbackCpiAccounts<'a, 'b>,
        args: InitStockpileRandCallbackInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `InitStockpileRandCallback` via CPI.
///
/// ### Accounts:
///
///   0. `[]` arcium_program
...
///   8. `[writable]` stockpile_secret
#[derive(Clone, Debug)]
pub struct InitStockpileRandCallbackCpiBuilder<'a, 'b> {
    instruction: Box<InitStockpileRandCallbackCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> InitStockpileRandCallbackCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(InitStockpileRandCallbackCpiBuilderInstruction {
            __program: program,
            arcium_program: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = InitStockpileRandCallbackCpi {
...
#[derive(Clone, Debug)]
struct InitStockpileRandCallbackCpiBuilderInstruction<'a, 'b> {
