...
pub const CONVERT_BUYBACK_SOL_TO_USDC_DISCRIMINATOR: [u8; 8] =
    [216, 16, 193, 21, 235, 103, 28, 153];

/// Accounts.
#[derive(Debug)]
pub struct ConvertBuybackSolToUsdc {
    ...
    /// Treasury-owned USDC account that receives the Meteora output.
...
impl ConvertBuybackSolToUsdc {
    pub fn instruction(
        &self,
        args: ConvertBuybackSolToUsdcInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = ConvertBuybackSolToUsdcInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct ConvertBuybackSolToUsdcInstructionData {
    discriminator: [u8; 8],
}

impl ConvertBuybackSolToUsdcInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [216, 16, 193, 21, 235, 103, 28, 153],
        }
    }
...
impl Default for ConvertBuybackSolToUsdcInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
pub struct ConvertBuybackSolToUsdcInstructionArgs {
    pub amount_in: u64,
    pub min_usdc_out: u64,
}

impl ConvertBuybackSolToUsdcInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `ConvertBuybackSolToUsdc`.
///
/// ### Accounts:
///
...
pub struct ConvertBuybackSolToUsdcBuilder {
...
impl ConvertBuybackSolToUsdcBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Crank authority that pays ATA rent when needed and requests the conversion.
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = ConvertBuybackSolToUsdc {
        ...
        let args = ConvertBuybackSolToUsdcInstructionArgs {
...
/// `convert_buyback_sol_to_usdc` CPI accounts.
pub struct ConvertBuybackSolToUsdcCpiAccounts<'a, 'b> {
    /// Crank authority that pays ATA rent when needed and requests the conversion.
...
/// `convert_buyback_sol_to_usdc` CPI instruction.
pub struct ConvertBuybackSolToUsdcCpi<'a, 'b> {
    ...
    pub __args: ConvertBuybackSolToUsdcInstructionArgs,
}

impl<'a, 'b> ConvertBuybackSolToUsdcCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: ConvertBuybackSolToUsdcCpiAccounts<'a, 'b>,
        args: ConvertBuybackSolToUsdcInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ConvertBuybackSolToUsdc` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` signer
...
///   17. `[]` system_program
#[derive(Clone, Debug)]
pub struct ConvertBuybackSolToUsdcCpiBuilder<'a, 'b> {
    instruction: Box<ConvertBuybackSolToUsdcCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ConvertBuybackSolToUsdcCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ConvertBuybackSolToUsdcCpiBuilderInstruction {
            __program: program,
            signer: None,
            config: None,
            treasury: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = ConvertBuybackSolToUsdcCpi {
...
#[derive(Clone, Debug)]
struct ConvertBuybackSolToUsdcCpiBuilderInstruction<'a, 'b> {
