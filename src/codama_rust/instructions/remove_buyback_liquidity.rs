...
pub const REMOVE_BUYBACK_LIQUIDITY_DISCRIMINATOR: [u8; 8] = [162, 33, 230, 119, 49, 191, 203, 163];

/// Accounts.
#[derive(Debug)]
pub struct RemoveBuybackLiquidity {
    ...
    pub buyback_lp_zinc_token_account: solana_address::Address,
    /// Dedicated treasury-owned token account that receives removed WSOL LP principal.
    pub buyback_lp_wsol_token_account: solana_address::Address,
...
impl RemoveBuybackLiquidity {
    pub fn instruction(
        &self,
        args: RemoveBuybackLiquidityInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new(
            self.buyback_lp_zinc_token_account,
            false,
        ));
        accounts.push(solana_instruction::AccountMeta::new(
            self.buyback_lp_wsol_token_account,
            false,
        ));
        accounts.push(solana_instruction::AccountMeta::new_readonly(
            self.pool_authority,
        ...
        let mut data = RemoveBuybackLiquidityInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct RemoveBuybackLiquidityInstructionData {
    discriminator: [u8; 8],
}

impl RemoveBuybackLiquidityInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [162, 33, 230, 119, 49, 191, 203, 163],
        }
    }
...
impl Default for RemoveBuybackLiquidityInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
pub struct RemoveBuybackLiquidityInstructionArgs {
    pub liquidity_delta: u128,
    pub token_a_amount_threshold: u64,
    pub token_b_amount_threshold: u64,
}

impl RemoveBuybackLiquidityInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `RemoveBuybackLiquidity`.
///
/// ### Accounts:
///
...
///   5. `[]` zinc_mint
///   6. `[writable]` buyback_lp_zinc_token_account
///   7. `[writable]` buyback_lp_wsol_token_account
///   8. `[]` pool_authority
///   9. `[writable]` pool
...
pub struct RemoveBuybackLiquidityBuilder {
    ...
    buyback_lp_zinc_token_account: Option<solana_address::Address>,
    buyback_lp_wsol_token_account: Option<solana_address::Address>,
...
impl RemoveBuybackLiquidityBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Admin signer authorized to remove protocol-owned LP principal.
    ...
    /// Dedicated treasury-owned token account that receives removed ZINC LP principal.
    #[inline(always)]
    pub fn buyback_lp_zinc_token_account(
        &mut self,
        buyback_lp_zinc_token_account: solana_address::Address,
    ) -> &mut Self {
        self.buyback_lp_zinc_token_account = Some(buyback_lp_zinc_token_account);
        self
    }
    /// Dedicated treasury-owned token account that receives removed WSOL LP principal.
    #[inline(always)]
    pub fn buyback_lp_wsol_token_account(
        &mut self,
        buyback_lp_wsol_token_account: solana_address::Address,
    ) -> &mut Self {
        self.buyback_lp_wsol_token_account = Some(buyback_lp_wsol_token_account);
        self
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = RemoveBuybackLiquidity {
            ...
            buyback_lp_zinc_token_account: self
                .buyback_lp_zinc_token_account
                .expect("buyback_lp_zinc_token_account is not set"),
            buyback_lp_wsol_token_account: self
                .buyback_lp_wsol_token_account
                .expect("buyback_lp_wsol_token_account is not set"),
        ...
        let args = RemoveBuybackLiquidityInstructionArgs {
...
/// `remove_buyback_liquidity` CPI accounts.
pub struct RemoveBuybackLiquidityCpiAccounts<'a, 'b> {
    /// Admin signer authorized to remove protocol-owned LP principal.
    ...
    /// Dedicated treasury-owned token account that receives removed ZINC LP principal.
    pub buyback_lp_zinc_token_account: &'b solana_account_info::AccountInfo<'a>,
    /// Dedicated treasury-owned token account that receives removed WSOL LP principal.
    pub buyback_lp_wsol_token_account: &'b solana_account_info::AccountInfo<'a>,
...
/// `remove_buyback_liquidity` CPI instruction.
pub struct RemoveBuybackLiquidityCpi<'a, 'b> {
    ...
    pub __args: RemoveBuybackLiquidityInstructionArgs,
}

impl<'a, 'b> RemoveBuybackLiquidityCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: RemoveBuybackLiquidityCpiAccounts<'a, 'b>,
        args: RemoveBuybackLiquidityInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
            ...
            buyback_lp_zinc_token_account: accounts.buyback_lp_zinc_token_account,
            buyback_lp_wsol_token_account: accounts.buyback_lp_wsol_token_account,
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new(
            *self.buyback_lp_zinc_token_account.key,
            false,
        ));
        accounts.push(solana_instruction::AccountMeta::new(
            *self.buyback_lp_wsol_token_account.key,
            false,
        ));
        accounts.push(solana_instruction::AccountMeta::new_readonly(
        ...
        account_infos.push(self.buyback_lp_zinc_token_account.clone());
        account_infos.push(self.buyback_lp_wsol_token_account.clone());
...
/// Instruction builder for `RemoveBuybackLiquidity` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` admin
...
///   17. `[]` system_program
#[derive(Clone, Debug)]
pub struct RemoveBuybackLiquidityCpiBuilder<'a, 'b> {
    instruction: Box<RemoveBuybackLiquidityCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RemoveBuybackLiquidityCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RemoveBuybackLiquidityCpiBuilderInstruction {
            __program: program,
            admin: None,
            config: None,
            treasury: None,
            ...
            wsol_mint: None,
            zinc_mint: None,
            buyback_lp_zinc_token_account: None,
            buyback_lp_wsol_token_account: None,
            pool_authority: None,
            pool: None,
            position: None,
    ...
    pub fn buyback_lp_zinc_token_account(
        &mut self,
        buyback_lp_zinc_token_account: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.buyback_lp_zinc_token_account = Some(buyback_lp_zinc_token_account);
        self
    }
    /// Dedicated treasury-owned token account that receives removed WSOL LP principal.
    #[inline(always)]
    pub fn buyback_lp_wsol_token_account(
        &mut self,
        buyback_lp_wsol_token_account: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
        self.instruction.buyback_lp_wsol_token_account = Some(buyback_lp_wsol_token_account);
        self
    }
    #[inline(always)]
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = RemoveBuybackLiquidityCpi {
...
#[derive(Clone, Debug)]
struct RemoveBuybackLiquidityCpiBuilderInstruction<'a, 'b> {
    ...
    buyback_lp_zinc_token_account: Option<&'b solana_account_info::AccountInfo<'a>>,
    buyback_lp_wsol_token_account: Option<&'b solana_account_info::AccountInfo<'a>>,
