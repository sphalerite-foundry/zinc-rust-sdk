...
pub const RETRY_INIT_STOCKPILE_RAND_DISCRIMINATOR: [u8; 8] = [230, 18, 35, 143, 73, 32, 162, 87];

/// Accounts.
#[derive(Debug)]
pub struct RetryInitStockpileRand {
...
impl RetryInitStockpileRand {
    pub fn instruction(
        &self,
        args: RetryInitStockpileRandInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = RetryInitStockpileRandInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct RetryInitStockpileRandInstructionData {
    discriminator: [u8; 8],
}

impl RetryInitStockpileRandInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [230, 18, 35, 143, 73, 32, 162, 87],
        }
    }
...
impl Default for RetryInitStockpileRandInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
pub struct RetryInitStockpileRandInstructionArgs {
    pub stockpile_id: u64,
    pub computation_offset: u64,
}

impl RetryInitStockpileRandInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `RetryInitStockpileRand`.
///
/// ### Accounts:
///
...
///   2. `[writable]` board
///   3. `[]` treasury
///   4. `[writable]` stockpile
///   5. `[writable]` stockpile_secret
...
///   15. `[]` stockpile_sol_vault
///   16. `[]` stockpile_token_account
...
///   19. `[optional]` arcium_program (default to `Arcj82pX7HxYKLR92qvgZUAd7vGS1k4hQvAFcPATFdEQ`)
#[derive(Clone, Debug, Default)]
pub struct RetryInitStockpileRandBuilder {
    ...
    stockpile_id: Option<u64>,
    computation_offset: Option<u64>,
    __remaining_accounts: Vec<solana_instruction::AccountMeta>,
}

impl RetryInitStockpileRandBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Pays for the Arcium retry queue transaction.
    ...
    #[inline(always)]
    pub fn stockpile_id(&mut self, stockpile_id: u64) -> &mut Self {
        self.stockpile_id = Some(stockpile_id);
        self
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = RetryInitStockpileRand {
        ...
        let args = RetryInitStockpileRandInstructionArgs {
            stockpile_id: self.stockpile_id.clone().expect("stockpile_id is not set"),
...
/// `retry_init_stockpile_rand` CPI accounts.
pub struct RetryInitStockpileRandCpiAccounts<'a, 'b> {
    /// Pays for the Arcium retry queue transaction.
...
/// `retry_init_stockpile_rand` CPI instruction.
pub struct RetryInitStockpileRandCpi<'a, 'b> {
    ...
    pub __args: RetryInitStockpileRandInstructionArgs,
}

impl<'a, 'b> RetryInitStockpileRandCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: RetryInitStockpileRandCpiAccounts<'a, 'b>,
        args: RetryInitStockpileRandInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `RetryInitStockpileRand` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` payer
...
///   19. `[]` arcium_program
#[derive(Clone, Debug)]
pub struct RetryInitStockpileRandCpiBuilder<'a, 'b> {
    instruction: Box<RetryInitStockpileRandCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RetryInitStockpileRandCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(RetryInitStockpileRandCpiBuilderInstruction {
            __program: program,
            payer: None,
            config: None,
            board: None,
    ...
    #[inline(always)]
    pub fn stockpile_id(&mut self, stockpile_id: u64) -> &mut Self {
        self.instruction.stockpile_id = Some(stockpile_id);
        self
    }
    #[inline(always)]
    pub fn computation_offset(&mut self, computation_offset: u64) -> &mut Self {
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let args = RetryInitStockpileRandInstructionArgs {
            stockpile_id: self
                ...
                .stockpile_id
                .clone()
                .expect("stockpile_id is not set"),
            computation_offset: self
                .instruction
                .computation_offset
                .clone()
        ...
        let instruction = RetryInitStockpileRandCpi {
...
#[derive(Clone, Debug)]
struct RetryInitStockpileRandCpiBuilderInstruction<'a, 'b> {
