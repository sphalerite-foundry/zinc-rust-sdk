...
pub const DEPLOY_ROUND_FROM_AUTO_SESSION_DISCRIMINATOR: [u8; 8] =
    [71, 122, 22, 191, 113, 52, 245, 81];

/// Accounts.
#[derive(Debug)]
pub struct DeployRoundFromAutoSession {
...
impl DeployRoundFromAutoSession {
    pub fn instruction(
        &self,
        args: DeployRoundFromAutoSessionInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = DeployRoundFromAutoSessionInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct DeployRoundFromAutoSessionInstructionData {
    discriminator: [u8; 8],
}

impl DeployRoundFromAutoSessionInstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [71, 122, 22, 191, 113, 52, 245, 81],
        }
    }
...
impl Default for DeployRoundFromAutoSessionInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
pub struct DeployRoundFromAutoSessionInstructionArgs {
...
/// Instruction builder for `DeployRoundFromAutoSession`.
///
/// ### Accounts:
///
...
///   7. `[writable]` board
///   8. `[writable]` treasury
///   9. `[writable]` stockpile_sol_vault
///   10. `[writable]` bonanza_sol_vault
///   11. `[writable]` buyback_sol_vault
///   12. `[optional]` stockpile
///   13. `[optional]` affiliate
///   14. `[writable, optional]` affiliate_profile
///   15. `[optional]` system_program (default to `11111111111111111111111111111111`)
#[derive(Clone, Debug, Default)]
pub struct DeployRoundFromAutoSessionBuilder {
...
impl DeployRoundFromAutoSessionBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    /// Configured crank executing the auto deploy.
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = DeployRoundFromAutoSession {
        ...
        let args = DeployRoundFromAutoSessionInstructionArgs {
...
/// `deploy_round_from_auto_session` CPI accounts.
pub struct DeployRoundFromAutoSessionCpiAccounts<'a, 'b> {
    /// Configured crank executing the auto deploy.
...
/// `deploy_round_from_auto_session` CPI instruction.
pub struct DeployRoundFromAutoSessionCpi<'a, 'b> {
    ...
    pub __args: DeployRoundFromAutoSessionInstructionArgs,
}

impl<'a, 'b> DeployRoundFromAutoSessionCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: DeployRoundFromAutoSessionCpiAccounts<'a, 'b>,
        args: DeployRoundFromAutoSessionInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `DeployRoundFromAutoSession` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` executor
...
///   15. `[]` system_program
#[derive(Clone, Debug)]
pub struct DeployRoundFromAutoSessionCpiBuilder<'a, 'b> {
    instruction: Box<DeployRoundFromAutoSessionCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DeployRoundFromAutoSessionCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(DeployRoundFromAutoSessionCpiBuilderInstruction {
            __program: program,
            executor: None,
            authority: None,
...
#[derive(Clone, Debug)]
struct DeployRoundFromAutoSessionCpiBuilderInstruction<'a, 'b> {
