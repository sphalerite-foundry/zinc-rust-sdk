...
pub enum ZincError {
    ...
    /// 6105 - LP inventory mint exceeds the configured supply cap
    #[error("LP inventory mint exceeds the configured supply cap")]
    LpInventoryMintExceedsSupplyCap = 0x17D9,
    /// 6106 - Meteora pool did not consume the exact requested LP seed amounts
    #[error("Meteora pool did not consume the exact requested LP seed amounts")]
    BuybackPoolSeedContributionMismatch = 0x17DA,
    /// 6107 - Buyback swap did not spend the exact requested WSOL amount
    #[error("Buyback swap did not spend the exact requested WSOL amount")]
    BuybackInputMismatch = 0x17DB,
    /// 6108 - Buyback output was below the requested minimum
    #[error("Buyback output was below the requested minimum")]
    BuybackSlippageExceeded = 0x17DC,
    /// 6109 - Treasury lamports changed during buyback swap
    #[error("Treasury lamports changed during buyback swap")]
    BuybackTreasuryLamportsChanged = 0x17DD,
    /// 6110 - ZINC mint supply changed during buyback swap
    #[error("ZINC mint supply changed during buyback swap")]
    BuybackMintSupplyChanged = 0x17DE,
    /// 6111 - Wrong staking token account
    #[error("Wrong staking token account")]
    WrongStakingTokenAccount = 0x17DF,
    /// 6112 - Wrong staking reward token account
    #[error("Wrong staking reward token account")]
    WrongStakingRewardTokenAccount = 0x17E0,
    /// 6113 - Wrong round ZINC reward token account
    #[error("Wrong round ZINC reward token account")]
    WrongRoundZincRewardTokenAccount = 0x17E1,
    /// 6114 - Wrong stake position
    #[error("Wrong stake position")]
    WrongStakePosition = 0x17E2,
    /// 6115 - Amount must be greater than zero
    #[error("Amount must be greater than zero")]
    AmountMustBeGreaterThanZero = 0x17E3,
    /// 6116 - No staking rewards are claimable
    #[error("No staking rewards are claimable")]
    NoStakingRewards = 0x17E4,
    /// 6117 - No round ZINC rewards are claimable
    #[error("No round ZINC rewards are claimable")]
    NoRoundZincRewards = 0x17E5,
    /// 6118 - No round SOL rewards are claimable
    #[error("No round SOL rewards are claimable")]
    NoRoundSolRewards = 0x17E6,
    /// 6119 - Insufficient staked balance
    #[error("Insufficient staked balance")]
    InsufficientStakedBalance = 0x17E7,
    /// 6120 - Unsupported account version
    #[error("Unsupported account version")]
    UnsupportedAccountVersion = 0x17E8,
