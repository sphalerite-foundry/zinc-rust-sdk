...
pub enum ZincError {
    ...
    /// 6172 - Wrong Wildcat entries sidecar
    #[error("Wrong Wildcat entries sidecar")]
    WrongWildcatEntries = 0x181C,
    /// 6173 - Wildcat entries sidecar is missing
    #[error("Wildcat entries sidecar is missing")]
    WildcatEntriesMissing = 0x181D,
    /// 6174 - Wildcat entry capacity is invalid
    #[error("Wildcat entry capacity is invalid")]
    InvalidWildcatEntryCapacity = 0x181E,
    /// 6175 - Wildcat entries have already been migrated
    #[error("Wildcat entries have already been migrated")]
    WildcatEntriesAlreadyMigrated = 0x181F,
