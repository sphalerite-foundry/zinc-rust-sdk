use crate::codama_rust::instructions::{
    InitRevealRoundRandCompDef, InitRevealRoundRandCompDefInstructionArgs,
};
...
pub struct InitRevealRoundRandCompDefInstructionInputs {
    pub payer: Pubkey,
...
impl InstructionsHelper {
    pub fn init_reveal_round_rand_comp_def_instruction(
        inputs: InitRevealRoundRandCompDefInstructionInputs,
    ) -> Instruction {
        let InitRevealRoundRandCompDefInstructionInputs {
            payer,
        ...
        .instruction(InitRevealRoundRandCompDefInstructionArgs {
